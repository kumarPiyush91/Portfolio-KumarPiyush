...
let speed = 100;
    ...
    body: `
      <div class="popup-profile">
        ...
        <div class="profile-info">
          <p>I am Piyush Kumar, a self-taught software engineer and <b>Author</b> with over 5 years of experience in software development. I have authored 10 books that have been published globally. I am passionate about coding, writing, and sharing knowledge. I actively contribute to open-source platforms and enjoy simplifying complex ideas into concepts that are easy to understand. Currently, I focus on building real-world applications using emerging technologies. I enjoy collaborating with creative individuals who are driven to build innovative and out-of-the-box solutions.</p>
        </div>
      </div>
    `
  },
  ...
  body: `
    ${[
      {
        category: "Frontend",
        items: ["HTML", "CSS", "JavaScript (ES6+)", "TypeScript", "Tailwind CSS", "React", "Next.js"]
      },
      {
        category: "State & Data",
      ...
      <div class="skill-group">
        ...
        <div>${group.items.map(s => `<span class="tag">${s}</span>`).join("")}</div>
      </div>
    `).join("")}
  `
},
    ...
    ${[
      {
        ...
        university: "Ranchi University, India",
        year: "2009 – 2012",
        
      },
      {
        degree: "Degree",
        field: "History (Honors)",
      ...
      <div class="edu-item">
        <p class="edu-degree"><span class="edu-label">${edu.degree}:</span> ${edu.field}</p>
        <p class="edu-university">${edu.university} &nbsp;|&nbsp; ${edu.year}</p>
  ...
  body: `
    ${[
      {
        company: "Promit & Company",
        gstin: "20ABBFP3869L1Z2",
        arn: "AA201125025773P",
        role: "Frontend Developer",
        duration: "2021 – Present",
        responsibilities: [
          "Developing responsive web applications",
          "Collaborating with Design & Backend team",
          "Implementing new features using modern frontend technologies",
          "Designed and implemented scalable micro-frontend architecture using React.js, Next.js, and TypeScript, enabling modular development and independent deployments"
        ]
      }
    ].map(exp => `
      <div class="exp-item">
        <p class="exp-role">${exp.role}</p>
        <p class="exp-company">${exp.company} &nbsp;|&nbsp; ${exp.duration}</p>
        <div class="exp-meta">
          <span class="exp-meta-item"><strong>GSTIN:</strong> ${exp.gstin}</span>
          <span class="exp-meta-item"><strong>ARN:</strong> ${exp.arn}</span>
        </div>
  ...
  body: `
    ${[
      {
        title: "Personal BookStore",
        url: "https://piyush-kumar.store/",
        desc: "With Secure PayPal payment integration"
      },
      {
        title: "Laughy",
        url: "https://addons.mozilla.org/en-US/firefox/addon/laughy/",
        desc: "Firefox AddOn"
      },
      {
        title: "Realtime Wildfire Tracker",
        url: "https://realtime-wildfire-tracker.netlify.app/",
        desc: "Used NASA EONET API to fetch real-time wildfires data globally"
      },
      {
        title: "Funny Error Excuse",
        url: "https://www.npmjs.com/package/funny-error-excuse",
        desc: "npm Package"
      },
      {
        title: "BreakOut",
      ...
      <div class="proj-item">
        <a href="${proj.url}" class="proj-link" target="_blank" rel="noopener noreferrer">
          <span class="proj-number">0${i + 1}</span>
          <div class="proj-info">
  ...
  // Overlay ke bahar click karne pe band ho
